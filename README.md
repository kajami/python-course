...
Book collection with user registration and user login. You can create user and login. After that you can add, edit and delete books with images to a database. 
<br>
<br>
